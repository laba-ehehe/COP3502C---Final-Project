class Cell: # This class represents a single cell in the Sudoku board. There are 81 Cells in a Board. 
    ...
    def draw(self): # Draws this cell, along with the value inside it. If this cell has a nonzero value, that value is displayed. Otherwise, no value is displayed in the cell. The cell is outlined red if it is currently selected. 
